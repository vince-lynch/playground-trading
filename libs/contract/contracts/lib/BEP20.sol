 ...
 */
contract BEP20 is Initializable, ContextUpgradeable, IBEP20, OwnableUpgradeable {
    ...
    function initializeToken(string memory name, string memory symbol, uint8 decimals, uint256 amount, bool mintable) public onlyOwner {
      _initialize(name, symbol, decimals, amount, mintable); //"SWINGBY token", "SWINGBY", 18, 1 * 10**9 * 10**18, false
    }
